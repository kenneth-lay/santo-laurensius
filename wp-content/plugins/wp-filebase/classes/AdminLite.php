...
static function SetupMenu()
{
	...
	{		
		...
		add_submenu_page($pm_tag, WPFB_PLUGIN_NAME.' - '.__($me['tit'], WPFB), empty($me['hide'])?__($me['tit'], WPFB):null, empty($me['cap'])?'activate_plugins':'activate_plugins', WPFB_OPT_NAME.'_'.$me['tag'], $callback);
	}
}
